                    ...
                    <li class="nav-item dropdown dropstart">
                      ...
                      role="button" data-bs-toggle="dropdown">Tài khoản</a>
	                      <ul class="dropdown-menu">
	                        ...
	                        <li><a class="dropdown-item" href="khachhang/update.jsp">Thay đổi thông tin</a></li>
	                        <li><a class="dropdown-item" href="khachhang/changePassword.jsp">Đổi mật khẩu</a></li>
	                        <li><hr class="dropdown-divider"></li>
	                        <li><a class="dropdown-item" href="khach-hang?hanhDong=log-out&">Thoát tài khoản</a></li>
	                      </ul>
                    </li>
                  </ul>
