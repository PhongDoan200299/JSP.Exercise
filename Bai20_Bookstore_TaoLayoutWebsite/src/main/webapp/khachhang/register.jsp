          ...
          <div class="col-md-6">
            ...
            <div class="form-group mb-3">
              <label for="tenDangNhap" class="form-label"
                >Tên đăng nhập<span class="red">*</span></label
              >
              <input
                type="text"
                class="form-control"
            ...
            <div class="form-group mb-3">
              <label for="matKhauNhapLai" class="form-label"
                >Nhập lại mật khẩu<span class="red">*</span><span id="msg" class="red"></span></label
              >
              <input
                type="password"
                class="form-control"
          ...
          <div class="col-md-6">
            ...
            <div class="mb-3">
              <label for="dongYDieuKhoan" class="form-label"
                >Đồng ý với<a>điều khoản công ty</a>
                <span id="red">*</span></label
              >
              <input
                type="checkbox"
